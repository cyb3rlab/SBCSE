        ...
        try:
            ...
            while self.running and not stop_event.is_set():
                ...
                if self.handler.mode in self.handler.mode_handlers:
                    self.handler.mode_handlers[self.handler.mode].handle_task(stop_event)
