"""
The basic function is consistent with mqtt_communication_module/Scenario_msg_handler/Normal_mode/BOS_normal_mode.py.
"""
import json
...
class FBosNormalMode(BOS_ModeHandler):
    def handle_msg(self, client, userdata, msg):
            ...
            self.bos_handler.forward_message_list.append([msg.topic, payload])